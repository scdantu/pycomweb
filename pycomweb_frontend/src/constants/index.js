...
export const ADV_FIL = {
    ...
    DISEASES_FILTER: {ID: "DISEASES_FILTER", DISPLAY_NAME: "Diseases"},
    COFACTORS_FILTER: {ID: "COFACTORS_FILTER", DISPLAY_NAME: "Cofactors"},
    ORGANISM_FILTER: {ID: "ORGANISM_FILTER", DISPLAY_NAME: "Organism"}
}
