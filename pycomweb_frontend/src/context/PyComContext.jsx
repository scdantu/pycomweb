...
export const PyComProvider = ({children}) =>{
    ...
    return (
        <PyComContext.Provider value= {{isSelectedTab, addProteinToTab, removeProteinFromTabs, updateSelectedProtein, proteinTabs, proteinRepository, addItemToProteinRepository, addItemsToProteinRepository, addHelpDataToProteinRespositoryItem, isHelpDataLoaded}}>
            {children}
