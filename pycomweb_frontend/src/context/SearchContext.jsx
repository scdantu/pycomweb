...
export const SearchProvider = ({children}) =>{
    ...
    return (
        <SearchContext.Provider value= {{isSelectedTab, addProteinToTab, removeProteinFromTabs, updateSelectedProtein, proteinTabs, proteinRepository, addItemToProteinRepository, addItemsToProteinRepository, addHelpDataToProteinRespositoryItem, isHelpDataLoaded}}>
            {children}
